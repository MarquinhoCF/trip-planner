import { Calendar, CircleCheck, CircleDashed, Link2, Mail, MapPin, Plus, Settings2, Tag, UserCog, X } from "lucide-react";
                        ...
                        <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
                            <div className='space-y-2'>
                                <div className='flex items-center justify-between'>
                                    ...
                                    <button>
                                        <X onClick={closeCreateActivityModal} className='size-5 bg-xinc-400' />
                                    </button>
                                </div>
